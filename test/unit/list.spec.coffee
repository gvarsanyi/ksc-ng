...
describe 'List', ->
  ...
  it 'Has overridden pop, push, shift and unshift, but default sort methods', ->
    list = new List
  ...
  it 'Upsert', ->
    ...
    affected = list.push {id: 1, x: 'y'}, {id: 4, x: 'e'}, {id: 2, x: 'y'}, true
  ...
  it 'Method .cut(records...)', ->
    list = new List
    list.push {id: 1, x: 'a'}, {id: 2, x: 'b'}, {id: 3, x: 'c'}, {id: 4, x: 'd'}
